    ...
    function connectSSE() {
      ...
      source.onmessage = (event) => {
        try {
          ...
          if (
            !chatId ||
            !incoming.wa_message_id
          ) {
            console.warn(
              "SSE message tidak memiliki chat_id:",
              incoming
            );
          ...
          const message = {
            ...
            whatsapp_bot_username:
              incoming.whatsapp_bot_username || "",
